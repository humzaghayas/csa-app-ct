...
import { useCustomersShoppinglistFetcher } from '../../../../hooks/use-customers-connector/use-customers-connector';
...
const columns = [
  { key: 'id', label: 'Shoppinglist Number' },
  { key: 'name', label: 'Shoppinglist Name' },
...
const CustomerShoppinglist = (props) => {
  ...
  //console.log(props.customer?.customerNumber);
  //console.log("props", customer);
  const tableSorting = useDataTableSortingState('createdAt desc');
  const { customersWishlistPaginatedResult, error, loading } = useCustomersShoppinglistFetcher({
    page,
    perPage,
    tableSorting,
    customerId
...
CustomerShoppinglist.displayName = 'CustomerShoppinglist';
CustomerShoppinglist.propTypes = {
