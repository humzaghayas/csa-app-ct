...
const CustomerPasswordForm = (props) => {
  ...
  // const resetToken = handleSubmit;
  const rows = [
    {
      TicketNumber: '00000001',
      FirstName: 'Lahari',
      PasswordRequest: '',
      LastUpdated: 'Nov 24, 2022,2:54:47...',
    },
    {
      TicketNumber: '00000002',
      FirstName: 'Lahari',
      PasswordRequest: '',
      LastUpdated: 'jun 05, 2022,2:54:47...',
    },
    {
      TicketNumber: '00000003',
      FirstName: 'Lahari',
      PasswordRequest: '',
      LastUpdated: 'May 21, 2022,2:54:47...',
    },
    {
      TicketNumber: '00000003',
      FirstName: 'Lahari',
      PasswordRequest: '',
      LastUpdated: 'Apr 11, 2022,2:54:47...',
    },
  ];
  // const { push } = useHistory();
  const columns = [
