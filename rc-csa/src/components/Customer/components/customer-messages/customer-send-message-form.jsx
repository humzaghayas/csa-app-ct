...
const CustomerSendMessageForm = (props) => {
...
CustomerSendMessageForm.displayName = 'CustomerSendMessageForm';
CustomerSendMessageForm.propTypes = {
...
export default CustomerSendMessageForm;
