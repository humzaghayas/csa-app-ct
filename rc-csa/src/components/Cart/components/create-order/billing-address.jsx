...
import { docToFormValues, docToFormValuess, formValuesToDoc, BillingInfo } from './conversions';
...
const BillingAddress = (props) => {
    ...
    //     }
    //     else {
    //         initialValues = docToFormValuess(cart?.billingAddress, projectLanguages)
    //     }
    // }
    ...
    return (
        <BillingAddressForm
            ...
            initialValues={props.isChecked ? docToFormValues(cart?.shippingAddress) : BillingInfo(cart?.billingAddress, projectLanguages)}
            //initialValues={BillingInfo(cart?.billingAddress, projectLanguages)}
