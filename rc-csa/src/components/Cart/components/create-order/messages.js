...
export default defineMessages({
  ...
  subTitle: {
    ...
    defaultMessage: 'Add shipping address details. Mandatory fields are marked with an asterisk (*).',
  },
  panelTitle: {
    id: 'EmployeeDetails.panelTitle',
    defaultMessage: 'Custom fields allow you to extend the information provided for Address. Load your preferred custom fields by selecting an option above.' ,
  },
  OrderPlaced: {
