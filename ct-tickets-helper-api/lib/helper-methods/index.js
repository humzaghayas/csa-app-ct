...
exports.createPassword =
  ...
  exports.getInvoiceNumber =
  exports.isEmailValid =
  exports.escapeQuotes =
  exports.getTicketFromCustomObject =
  exports.getForKey =
  exports.createTicketHistory =
  exports.createTicketHistoryForDB =
  exports.getCreateTicketDraftForDB =
  exports.getCreateTicketDraft =
  exports.getCreateTicketMutaion =
  exports.getTicketContactTypes =
  exports.getTicketPriorityValues =
  exports.getTicketCategories =
  exports.getCartRows =
    ...
    return customObjects === null || customObjects === void 0
      ...
      : customObjects.results.map(function (co) {
          return {
            ...
            customerId: co?.value?.customerId,
            Created: co?.value?.createdAt,
            Modified: co?.value?.lastModifiedAt,
            Resolution: co?.value?.resolutionDate,
            ticketData: co?.value?.ticketData,
            contactType: co?.value?.contactType,
...
function getOrderRows(orderPaginationResult) {
  if (
    orderPaginationResult === null || orderPaginationResult === void 0
      ? void 0
      : orderPaginationResult.results
  ) {
    return orderPaginationResult === null || orderPaginationResult === void 0
      ? void 0
      : orderPaginationResult.results.map(function (order) {
          var _a, _b, _c, _d, _e;
          return {
            ...
            orderState:
              order === null || order === void 0 ? void 0 : order.orderState,
            shipmentStatus:
              order === null || order === void 0
                ? void 0
                : order.shipmentStatus,
            paymentStatus:
              order === null || order === void 0 ? void 0 : order.paymentStatus,
            shippingMethodName:
              (_c =
                order === null || order === void 0
                  ? void 0
                  : order.shippingInfo) === null || _c === void 0
                ? void 0
                : _c.shippingMethodName,
            orderTotal:
              order === null || order === void 0 ? void 0 : order.orderTotal,
            noOforderItems:
              (_d =
                order === null || order === void 0
                  ? void 0
                  : order.lineitems) === null || _d === void 0
                ? void 0
                : _d.length,
            totalItems:
              (_e =
                order === null || order === void 0
                  ? void 0
                  : order.lineitems) === null || _e === void 0
                ? void 0
                : _e.quantity,
          };
        });
...
function getCartRows(cartPaginationResult) {
  ...
  if (
    cartPaginationResult === null || cartPaginationResult === void 0
      ? void 0
      : cartPaginationResult.results
  ) {
    return cartPaginationResult === null || cartPaginationResult === void 0
      ? void 0
      : cartPaginationResult.results.map(function (carts) {
          var _a, _b;
          return {
            id: carts.id,
            customer:
              ((_a = carts.customer) === null || _a === void 0
                ? void 0
                : _a.firstName) +
              " " +
              ((_b = carts.customer) === null || _b === void 0
                ? void 0
                : _b.lastName),
...
function getCreateTicketDraft(ticketInfo) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      ...
      commentsStr =
        (_a =
          ticketInfo === null || ticketInfo === void 0
            ? void 0
            : ticketInfo.comments) === null || _a === void 0
          ? void 0
          : _a
              .map(function (c) {
                if (c.createdAt) {
                  return '{"comment":"'
                    .concat(c.comment, '","createdAt":"')
                    .concat(c.createdAt, '"}');
                } else {
                  return '{"comment":"'
                    .concat(c.comment, '","createdAt":"')
      ...
      if (
        ticketInfo.category &&
        (ticketInfo.category ==
          constants_1.CONSTANTS.TICKET_TYPE_ORDER_INQUIRY ||
          ticketInfo.category ==
            constants_1.CONSTANTS.TICKET_TYPE_PAYMENT_METHODS ||
          ticketInfo.category == constants_1.CONSTANTS.TICKET_TYPE_RETURNS)
      ) {
        orderNumberStr = ',"orderNumber":"'.concat(ticketInfo.orderNumber, '"');
      }
      value = '"ticketData":{\t\n        "message": "'
        .concat(ticketInfo.message, '",\n        "files": [')
        .concat(filesStr, '],\n        "comments":[')
        .concat(commentsStr, "]\n        ")
        .concat(orderNumberStr, "}");
      ticketDraft.value = getTicketValueString(ticketInfo, uuid);
      ticketDraft.value = ticketDraft.value.replace(
        constants_1.CONSTANTS.TICKET_DATA,
        value
      );
...
function getCreateTicketDraftForDB(ticketInfo) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      ...
      if (
        ticketInfo === null || ticketInfo === void 0 ? void 0 : ticketInfo._id
      ) {
        ticketDraft._id =
          ticketInfo === null || ticketInfo === void 0
            ? void 0
      ...
      historyVal =
        history === null || history === void 0
          ...
          : history.map(function (h) {
              ...
              return (
                (_a = {}),
                (_a[constants_1.CONSTANTS.PRIORITY] =
                  h[constants_1.CONSTANTS.PRIORITY]),
                (_a[constants_1.CONSTANTS.STATUS] =
                  h[constants_1.CONSTANTS.STATUS]),
                (_a[constants_1.CONSTANTS.ASSIGNED_TO] =
                  h[constants_1.CONSTANTS.ASSIGNED_TO]),
                (_a.user = h.user),
                (_a.operationDate = h.operationDate),
                _a
              );
            });
      ...
      historyString =
        history === null || history === void 0
          ...
          : history
              .map(function (h) {
                return '{"'
                  .concat(constants_1.CONSTANTS.PRIORITY, '":"')
                  .concat(
                    h[constants_1.CONSTANTS.PRIORITY],
                    '",\n                "'
                  )
                  .concat(constants_1.CONSTANTS.STATUS, '":"')
                  .concat(
                    h[constants_1.CONSTANTS.STATUS],
                    '",\n                "'
                  )
                  .concat(constants_1.CONSTANTS.ASSIGNED_TO, '":"')
                  .concat(
                    h[constants_1.CONSTANTS.ASSIGNED_TO],
                    '",\n                "user":"'
                  )
                  .concat(h.user, '","operationDate":"')
                  .concat(h.operationDate, '"}');
              })
              .toString();
      ticketDraft.value = ticketDraft.value.replace(
        constants_1.CONSTANTS.TICKET_HISTORY,
        '"history":['.concat(historyString, "]")
      );
      return [2 /*return*/];
    });
  });
...
function getTicketValueString(ticketInfo, uuid) {
  ...
  return '{\n        "id": "'
    ...
    .concat(customerId, '",\n        "email":"')
    .concat(email, '",\n        "source": "')
    .concat(ticketInfo.contactType, '",\n        "status": "')
    .concat(ticketInfo.status, '",\n        "priority": "')
    .concat(ticketInfo.priority, '",\n        "category": "')
    .concat(ticketInfo.category, '",\n        "subject": "')
    .concat(ticketInfo.subject, '",\n        "type":"')
    .concat(ticketInfo.category, '",\n        "createdAt": "')
    .concat(currentDate, '",\n        "lastModifiedAt": "')
    .concat(currentDate, '",\n        "createdBy":"')
    .concat(ticketInfo.createdBy, '",\n        "assignedTo":"')
    .concat(ticketInfo.assignedTo, '",\n        ')
  ...
  ticket["message"] =
    (_d =
      (_c =
        (_b =
          (_a =
            data === null || data === void 0 ? void 0 : data.customObject) ===
            null || _a === void 0
            ? void 0
            : _a.value) === null || _b === void 0
          ? void 0
          : _b.ticketData) === null || _c === void 0
        ? void 0
    ...
    (_m =
      (_l =
        (_k =
          ...
          ? void 0
          : _k.ticketData) === null || _l === void 0
        ? void 0
        : _l.comments) !== null && _m !== void 0
      ? _m
      : [];
...
function createTicketFromCustomObject(data) {
  ...
  return {
    id:
      (_b =
        (_a = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _a === void 0
          ? void 0
    ...
    ticketNumber:
      (_e =
        (_d =
          ...
          ? void 0
          : _d.ticketNumber) !== null && _e !== void 0
        ? _e
        : "",
    key:
      (_g =
        (_f = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _f === void 0
          ? void 0
          : _f.key) !== null && _g !== void 0
        ? _g
        : "",
    container:
      (_j =
        (_h = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _h === void 0
          ? void 0
          : _h.container) !== null && _j !== void 0
        ? _j
        : "",
    version:
      (_l =
        (_k = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _k === void 0
          ? void 0
          : _k.version) !== null && _l !== void 0
        ? _l
        : "",
    category:
      (_p =
        (_o =
          (_m =
            ...
            null || _m === void 0
            ? void 0
            : _m.value) === null || _o === void 0
          ? void 0
          : _o.category) !== null && _p !== void 0
        ? _p
        : "",
    Customer:
      (_s =
        (_r =
          (_q =
            ...
            null || _q === void 0
            ? void 0
            : _q.value) === null || _r === void 0
          ? void 0
          : _r.email) !== null && _s !== void 0
        ? _s
        : "",
    contactType:
      (_v =
        (_u =
          (_t =
            ...
            null || _t === void 0
            ? void 0
            : _t.value) === null || _u === void 0
          ? void 0
          : _u.source) !== null && _v !== void 0
        ? _v
        : "",
    status:
      (_y =
        (_x =
          (_w =
            ...
            null || _w === void 0
            ? void 0
            : _w.value) === null || _x === void 0
          ? void 0
          : _x.status) !== null && _y !== void 0
        ? _y
        : "",
    priority:
      (_1 =
        (_0 =
          (_z =
            ...
            null || _z === void 0
            ? void 0
            : _z.value) === null || _0 === void 0
          ? void 0
          : _0.priority) !== null && _1 !== void 0
        ? _1
        : "",
    subject:
      (_4 =
        (_3 =
          (_2 =
            ...
            null || _2 === void 0
            ? void 0
            : _2.value) === null || _3 === void 0
          ? void 0
          : _3.subject) !== null && _4 !== void 0
        ? _4
        : "",
    lastModifiedAt:
      (_6 =
        (_5 = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _5 === void 0
          ? void 0
          : _5.lastModifiedAt) !== null && _6 !== void 0
        ? _6
        : "",
    createdAt:
      (_8 =
        (_7 = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _7 === void 0
          ? void 0
          : _7.createdAt) !== null && _8 !== void 0
        ? _8
        : "",
    email:
      (_10 =
        (_9 = data === null || data === void 0 ? void 0 : data.customObject) ===
          null || _9 === void 0
          ? void 0
          : _9.value.email) !== null && _10 !== void 0
        ? _10
        : "",
    customerId:
      (_12 =
        (_11 =
          ...
          null || _11 === void 0
          ? void 0
          : _11.value.customerId) !== null && _12 !== void 0
        ? _12
        : "",
    assignedTo:
      (_14 =
        (_13 =
          ...
          null || _13 === void 0
          ? void 0
          : _13.value.assignedTo) !== null && _14 !== void 0
        ? _14
        : "",
    createdBy:
      (_16 =
        (_15 =
          ...
          null || _15 === void 0
          ? void 0
          : _15.value.createdBy) !== null && _16 !== void 0
        ? _16
        : "",
    orderNumber:
      (_20 =
        (_19 =
          (_18 =
            (_17 =
              ...
              null || _17 === void 0
              ? void 0
              : _17.value) === null || _18 === void 0
            ? void 0
            : _18.ticketData) === null || _19 === void 0
          ? void 0
          : _19.orderNumber) !== null && _20 !== void 0
        ? _20
        : "",
    history:
      (_23 =
        (_22 =
          (_21 =
            ...
            null || _21 === void 0
            ? void 0
            : _21.value) === null || _22 === void 0
          ? void 0
          : _22.history) !== null && _23 !== void 0
        ? _23
        : [],
  };
}
...
function getInvoiceNumber(prefix) {
  ...
  invoiceNumber = invoiceNumber
    ? invoice_number_1.InvoiceNumber.next(invoiceNumber)
    : ""
        .concat(today.getFullYear())
        .concat(today.getMonth() + 1)
        .concat(today.getDate(), "-")
        .concat(today.getHours())
        .concat(today.getMinutes());
...
function getPaymentList(orders) {
  var _a;
  var paymentList = [];
  (_a = orders === null || orders === void 0 ? void 0 : orders.results) ===
    null || _a === void 0
    ? void 0
    : _a.forEach(function (o) {
        o.paymentInfo.payments.forEach(function (p) {
          var payment = {};
          payment["orderNumber"] = o.id;
          if (p.transactions && p.transactions.length > 0) {
            var trans = p.transactions.find(function (t) {
            ...
            if (trans) {
              ...
              var trans_1 = p.transactions.find(function (t) {
              ...
              if (trans_1) {
                ...
                var trans_2 = p.transactions.find(function (t) {
                ...
                if (trans_2) {
                  ...
                  var trans_3 = p.transactions.find(function (t) {
                    return t.state === "Initial";
                  });
                  if (trans_3) {
